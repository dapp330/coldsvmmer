...
const NavbarComponent = () => {
  ...
  const listenScrollEvent = (event) => {
    if (window.scrollY < 73) {
      ...
      return setHeader(`${headerClass} bg-black-60 z-999 `);
    }
  };
  ...
  return (
    <body>
      <header class="fixed">
        <nav class={header}>
          <Link to="/" class=" ph3 white link dim underline-hover" title="home">
            HOME
          </Link>
          <Link
            to="gallery"
            class=" white link dim underline-hover"
            href="#"
            title="galery"
          >
            GALERY
          ...
          <Link
            to="about"
            class="ph3 white link dim underline-hover "
            href="#"
            title="about"
          >
            ABOUT
          ...
          <div class="dtc v-mid w-75 tr">
            <a
              class="link dim white f6 f5-ns dib mr3 mr4-ns"
            ...
            <a
              class="link dim white f6 f5-ns dib"
